...
<div>
	<p>
		„Beeinträchtigungen der psychischen Gesundheit sind weit verbreitet und reichen von leichten
		Einschränkungen des seelischen Wohlbefindens bis zu schweren psychischen Störungen.“ (RKI,
		2023). Zu psychischen Erkrankungen (oder Störungen) zählen unter anderem Depressionen,
		Angststörungen, Verhaltensstörungen, bipolare Störungen und Psychosen. Symptome können hierbei
		Kombinationen von belastenden Gedanken, Emotionen, Verhaltensweisen und Beziehungen zu anderen
		sein.
	</p>
	<p>
	...
	<Sources
		sources={[
			{
				title: 'Stiftung Deutsche Depressionshilfe und Suizidprävention',
