...
<p>
	...
	der Hochschule der Medien (HdM) Stuttgart im Verbund mit Projektpartnern (Universität Bielefeld, Pädagogische
	Hochschule Heidelberg sowie Pädagogische Hochschule Freiburg). Die voraussichtliche Projektdauer beträgt
	3 Jahre (01.08.2021 bis 31.07.2024). Das Projekt wird gefördert von der
...
<p>
	...
	haben großes Potenzial, die Teilhabe von Studierenden an Hochschulen chancengerecht zu gestalten.
	Gleichzeitig sind Digitalisierungsprozesse kein Garant für Barrierefreiheit. Das Forschungsprojekt
	SHUFFLE hat zum Ziel, <strong
		>digitale Barrierefreiheit als Qualitätsmerkmal an Hochschulen</strong
	> zu verankern. Dazu soll ein Modell entwickelt werden, womit Hochschulen bestehende Zustände und Prozesse
	bezüglich digitaler Barrierefreiheit messen, bewerten und erforderlichenfalls verbessern können. Die
	vorliegende Website dient der Vorstellung des Projekts, stellt wichtige Informationen hierzu zur Verfügung
	und eröffnet die Möglichkeit zur Kontaktaufnahme. Gleichzeitig sollen dabei die Vorgaben und Bedingungen
	barrierefreier (digitaler) Kommunikation gewährleistet werden.
</p>
<p>
	...
	>). Aus diesem Grund können auch Betroffenenrechte (Auskunfts-, Berichtigungs-, Beschränkungs- und
	...
	>,
	<a class="focus-indicator" href="https://dejure.org/gesetze/DSGVO/21.html">Art. 21 Abs. 6 DSGVO</a
	> eingeschränkt sein.
</p>
...
<p>
	Die Website dient der Information und Bekanntmachung des Forschungsprojekts SHUFFLE, nicht dagegen
	sonstigen Marketingzwecken oder außerhalb des Projekts stehenden Zwecke. Konkret personenbezogene
	Daten werden grundsätzlich nicht erhoben (s. hierzu Ziff. 3.1.2).
</p>
<p>
	Eine Ausnahme hierzu bildet die Möglichkeit der Eingabe Ihrer Daten in ein entsprechendes
	Kontaktformular, wo Nutzende freiwillig personenbezogene Daten (Name, Mailadresse) in das Formular
	eingeben können.
</p>
...
<p>
	...
	handelt es sich z.B. um ein Erklärvideo in Gebärdensprache. Diese Funktionen werden auf denselben
	HdM-internen Servern wie die Website gehostet.
</p>
<p>
...
<p>
	Rechtsgrundlage für die Datenverarbeitungen ist insofern die Einwilligung gemäß Art. 6 Abs. 1 lit.
	a (durch informiertes und bewusstes Abrufen der Funktion/des Dienstes) oder auch ein berechtigtes
	Interesse gemäß Art. 6 Abs. 1 lit. e bzw. lit. f DSGVO, ggfs. auch in Verbindung mit dem
	Forschungsprivileg (s.o.).
</p>
...
<p>
	...
	einem Landesarchiv. Rechtsgrundlage wäre hier eine rechtliche Verpflichtung gem. Artikel 6 Abs. 1
	lit. c DSGVO, im Fall einer Einwilligung (z.B. Kontaktformular) Artikel 6 Abs. 1 lit. a und für
	sog. „besondere Kategorien“ (z.B. Gesundheitsdaten) Artikel 9 Abs. 2 lit. j DSGVO, gegebenenfalls
	auch in Verbindung mit dem sog. Forschungsprivileg (s.o.).
</p>
<h3 id="dauer-der-speicherung">3.3 Dauer der Speicherung</h3>
<p>
	Die unter Ziffer 3.1.2 genannten Datenverarbeitungen werden diesseits gelöscht oder anonymisiert,
	sobald der Zweck der Speicherung entfällt und sofern der Löschung bzw. Anonymisierung keine
	gesetzlichen Aufbewahrungspflichten entgegenstehen. Dies gilt grundsätzlich auch für solche Daten,
	die (ausschließlich) aufgrund einer erteilten Einwilligung erhoben wurden, z.B. nach dem Ausfüllen
	und Absenden des Kontaktformulars (gem. Grundsätzen des <em lang="en">privacy by design</em>,
	<a class="focus-indicator" href="https://dejure.org/gesetze/DSGVO/25.html">Art. 25 Abs. 1 DSGVO</a
	>)
</p>
...
<ul>
	<li>
		<strong>Auskunft</strong> über die verarbeiteten Daten, Informationen über die Datenverarbeitung
		sowie auf Kopien von Daten (<a
			class="focus-indicator"
...
<p>
	...
	schutzwürdige Gründe, die die Interessen der betroffenen Person überwiegen, nicht entgegenstehen,
	besteht ein Recht auf Widerspruch nach <a
		class="focus-indicator"
...
<p>
	...
	>
	bzw.
	<a class="focus-indicator" href="https://dejure.org/gesetze/DSGVO/89.html">Art. 89 Abs. 1 DSGVO</a
	>
	i.V.m.
	...
	Forschungszwecke unmöglich gemacht oder ernsthaft beeinträchtigt werden kann und die Beschränkung
	zur Erfüllung des Forschungs- oder Statistikzwecks notwendig ist.
</p>
<p>
	...
	>, falls personenbezogene Daten unter Verstoß gegen datenschutzrechtliche Bestimmungen verarbeitet
	werden (<a class="focus-indicator" href="https://dejure.org/gesetze/DSGVO/77.html"
		>Art. 77 DSGVO</a
