<script lang="ts">
	...
	const contentsArray = [
		...
		},
		{
			...
			mood: '',
			description:
				'Oh, was ist denn jetzt passiert? Ihr Bildschirm scheint eine Fehlfunktion zu haben und zeigt nur noch einen kleinen Ausschnitt der Folien. Können Sie trotzdem die Quelle ermitteln?',
			solution: 'NONE'
		},
		{
	...
	// function moveHole(event: any) {
	// 	if (holeMoveable) {
	// 		holePosX = event.clientX - hole.clientWidth / 2;
	// 		holePosY = event.clientY - hole.clientHeight / 2;
	// 	}
	// }
